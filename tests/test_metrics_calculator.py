...
class TestMetricsCalculator(unittest.TestCase):
    ...
    def test_max_drawdown_simple(self):
        ...
        self.metrics.closed_trades = [
            {'pnl': 100, 'symbol': 'NIFTY', 'timestamp': datetime.now()},  # Equity: 100
            {'pnl': 50, 'symbol': 'NIFTY', 'timestamp': datetime.now()},   # Equity: 150 (peak)
            {'pnl': -30, 'symbol': 'NIFTY', 'timestamp': datetime.now()},  # Equity: 120
            {'pnl': -20, 'symbol': 'NIFTY', 'timestamp': datetime.now()},  # Equity: 100
        ]
